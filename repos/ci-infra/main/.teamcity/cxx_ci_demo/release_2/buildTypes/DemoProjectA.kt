...
object Release2_DemoProjectA : BuildType({
    id((Release2Id / "DemoProjectA").toString())
    ...
    vcs {
        root(Release2_DemoProjectAVcs, "%vcs_rules%")
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_5"
            buildType = "${Release2_DemoProjectB.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
    ...
    dependencies {
        dependency(Release2_DemoProjectB) {
            snapshot {
