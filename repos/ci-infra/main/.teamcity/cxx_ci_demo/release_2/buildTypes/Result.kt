...
// Named Track2_ResultBuild, not Result — "Result" would shadow kotlin.Result from the stdlib's
// implicit import.
//
...
object Track2_ResultBuild : BuildType({
    id((Track2Id / "Result").toString())
    name = "result"
