...
// Named Release2_ResultBuild, not Result — "Result" would shadow kotlin.Result from the stdlib's
// implicit import.
//
...
object Release2_ResultBuild : BuildType({
    id((Release2Id / "Result").toString())
    name = "result"
    ...
    dependencies {
        dependency(Release2_DemoProjectA) {
            snapshot {
