...
// Same id as the Release2_ProjectB buildType (buildTypes/ProjectB.kt) — allowed, VCS roots and
// build types have separate id namespaces in TeamCity. Matches what was already live.
object Release2_ProjectBVcs : GitVcsRoot({
    id((Release2Id / "ProjectB").toString())
    name = "project_b"
