...
// Same id as the Main_DemoProjectD buildType (buildTypes/DemoProjectD.kt) — allowed, VCS roots and
// build types have separate id namespaces in TeamCity. Matches what was already live for A/B.
object Main_DemoProjectDVcs : GitVcsRoot({
    id((MainId / "DemoProjectD").toString())
    name = "demo-project-d"
    url = "http://gitlab:8929/root/demo-project-d.git"
