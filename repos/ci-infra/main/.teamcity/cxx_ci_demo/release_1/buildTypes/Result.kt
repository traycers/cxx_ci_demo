...
// Named Track1_ResultBuild, not Result — "Result" would shadow kotlin.Result from the stdlib's
// implicit import.
//
...
object Track1_ResultBuild : BuildType({
    id((Track1Id / "Result").toString())
    name = "result"
