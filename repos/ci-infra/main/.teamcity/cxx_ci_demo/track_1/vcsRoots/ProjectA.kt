...
// Same id as the Track1_ProjectA buildType (buildTypes/ProjectA.kt) — allowed, VCS roots and
...
object Track1_ProjectAVcs : GitVcsRoot({
    id((Track1Id / "ProjectA").toString())
    name = "project_a"
