...
object Release3_ProjectB : BuildType({
    id((Release3Id / "ProjectB").toString())
    templates(Release3_BaseBuild)
    name = "project_b"

    // release_3's chain is a -> c -> d (see ADR 0009); nothing in this release depends on project_b's
    ...
    vcs {
        root(Release3_ProjectBVcs, "%vcs_rules%")
