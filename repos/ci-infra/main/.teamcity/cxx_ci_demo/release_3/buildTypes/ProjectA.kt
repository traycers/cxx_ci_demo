...
// 03's research).
object Release3_ProjectA : BuildType({
    id((Release3Id / "ProjectA").toString())
    ...
    vcs {
        root(Release3_ProjectAVcs, "%vcs_rules%")
    ...
    triggers {
        ...
        finishBuildTrigger {
            id = "TRIGGER_5"
            buildType = "${Release3_ProjectC.id}"
            successfulOnly = true
            branchFilter = ""
        }
    }
